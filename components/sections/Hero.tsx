        ...
        <div className="lg:justify-self-end">
          <div className="card p-6 w-full max-w-md">
            ...
            <div className="mt-6 rounded-lg border border-ink-100 p-4">
              <p className="text-xs text-gray-400">Vet-ready integration</p>
              <p className="text-sm text-gray-300">Works with existing clinic software. Share via link or scan, no install required.</p>
            </div>
          </div>
        </div>
      </div>
